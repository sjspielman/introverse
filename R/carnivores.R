...
#'
#' @format A tibble (data frame) with 9 rows and 4 variables:
#' \describe{
#'   \item{name}{common name of the carnivore species}
#'   \item{genus}{the genus classification of the carnivore species}
#'   \item{awake}{the number of hours, on average, this species spends awake per day}
