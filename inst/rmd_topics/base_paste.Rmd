...
We use these functions combine multiple strings (or other values that will be coerced into characters) into one. The `paste()` function combines all provided strings separated by a space or a provided other "separator." The `paste0()` function combines all provided strings _without_ any separator.
