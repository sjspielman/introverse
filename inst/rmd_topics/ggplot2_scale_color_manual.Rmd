...
|:-----------|:-------------
|  `scale_color_manual()` (aka `scale_colour_manual()`)   | Specify custom _discrete colors_ to use for mapping
|  `scale_fill_manual()`  | Specify custom fills to use for mapping
|  `scale_color_gradient()` (aka `scale_colour_gradient()`)   | Specify custom _continuous gradient_ to use for mapping
|  `scale_color_gradient2()` (aka `scale_colour_gradient2()`)   | Specify custom _continuous gradient2_ colors to use for mapping|  
| `scale_fill_gradient()` | Specify custom _continuous gradient_ fills to use for mapping
| `scale_fill_gradient2()` | Specify custom _continuous gradient2_ fills to use for mapping
