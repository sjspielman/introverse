...
Logical operators are symbols you can make comparisons with **that tell you `TRUE` or `FALSE`**. _Logical statement_ is any piece of code that evaluates to `TRUE` or `FALSE`, i.e. it contained a logical operator. Note that in other computing languages, these operators and statements are often called "boolean" (boo-lee-an) and not logical
