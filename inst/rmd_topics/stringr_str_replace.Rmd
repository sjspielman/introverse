...
The [`str_replace()`](https://stringr.tidyverse.org/reference/str_replace.html) and  [`str_replace_all()`](https://stringr.tidyverse.org/reference/str_replace.html) functions are part of the [`{stringr}`](https://stringr.tidyverse.org/) package, which is part of the [`{tidyverse}`](https://www.tidyverse.org/).
