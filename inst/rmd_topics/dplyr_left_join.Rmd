...
The [`left_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.html) function is part of the [`{dplyr}`](https://dplyr.tidyverse.org/) package, which is part of the [`{tidyverse}`](https://www.tidyverse.org/).
