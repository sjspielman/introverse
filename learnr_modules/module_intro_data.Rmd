...
elements <- tibble::tribble(
  ...
  select(-periodic_table_period, -periodic_table_group, -atomic_radius, -density) %>%
...
+ `specific_heat`: The specific heat of an element. Specific heat, according to Wikipedia, is the "amount of energy that must be added, in the form of heat, to one unit of mass of the substance in order to cause an increase of one unit in temperature." 
...
## Part 3: Identifying types of data visualizations

Imagine we want to visualize the some of the variables in this periodic table dataset (each column in a variable). For each scenario, indicate what type(s) of plot(s) could be acceptable choices for the visualization goal.
...
quiz(caption = "",
     question("What types of plot(s) would be appropriate to visualize `atomic_mass`? Select all that apply.",
     ...
     question("What types of plot(s) would be appropriate to visualize `hardsoft_acidbase_theory`? Select all that apply.",
              answer("Histogram"),
              answer("Scatterplot"),            
     ...
     question("What types of plot(s) would be appropriate to visualize `electronegativity`? Select all that apply.",
              answer("Histogram", correct = TRUE),
              answer("Scatterplot"),            
              answer("Barplot"),
              answer("Boxplot", correct = TRUE),
     ...
     question("What types of plot(s) would be appropriate to visualize the relationship between `number_of_protons` and `atomic_mass`? Select all that apply.",
              answer("Histogram"),
     ...
     question("What types of plot(s) would be appropriate to visualize `metal_type`? Select all that apply.",
              answer("Histogram"),
              answer("Scatterplot"),            
              answer("Barplot", correct = TRUE),
              answer("Boxplot"),
     ...
     question("What types of plot(s) would be appropriate to visualize the relationship between `hardsoft_acidbase_theory` and `atomic_mass`? In other words, we want to visualize the distribution of `atomic_mass` values for each `hardsoft_acidbase_theory` category (or vice versa). Select all that apply.",
              answer("Histogram", correct = TRUE),
              answer("Scatterplot"),            
              answer("Barplot"),
              answer("Boxplot", correct = TRUE),
     ...
     question("What types of plot(s) would be appropriate to visualize the relationship between `hardsoft_acidbase_theory` and `metal_type`? In other words, we want to visualize the distribution of `hardsoft_acidbase_theory` values for each `metal_type` category. Select all that apply.",
              answer("Histogram"),
              answer("Scatterplot"),            
              answer("Barplot", correct = TRUE),
              answer("Boxplot"),
...
<!--
+ Is there a color/fill in the dataset. If so, is the color/fill mapped to a variable (and which variable), or is it "just a color/fill"? 
-->
...
ggplot(elements, aes(x = metal_type)) + 
  geom_bar(fill = "blue") + 
...
quiz(caption = "",
     ...
     question("What variable, if any, is on the X axis?",
              ...
              answer("`metal_type`", correct = TRUE),
              answer("`specific_heat`"),
              answer("None of the above: A data transformation is on the X-axis"),
              allow_retry = TRUE,
              type = "multiple"
              ),
     question("What variable, if any, is on the Y axis?",
              ...
              answer("`metal_type`"),
              answer("`specific_heat`"),
              answer("None of the above: A data transformation is on the Y-axis", correct = TRUE),
              allow_retry = TRUE,
              type = "multiple"
              )
     )
#     question("If there is a color or fill, it is 'just a color/fill', or is it  mapped to a variable? If the latter, select which variable to which the color/fill maps.",
#              answer("NA - there is no color/fill"),
#              answer("Just a color/fill.", correct = TRUE),
#              answer("Maps to `element_name`"),
#              answer("Maps to `element_abbr`"),
#              answer("Maps to `hardsoft_acidbase_theory`"),
#              answer("Maps to `atomic_mass`"),
#              answer("Maps to `number_of_protons`"),
#              answer("Maps to `electronegativity`"),
#              answer("Maps to `metal_type`"),
#              answer("Maps to `specific_heat`"),
#              allow_retry = TRUE
#            ) 
```
...
ggplot(elements, aes(x = electronegativity)) + 
  ...
  labs(x = "Electronegativity", title = "Distribution of element electronegavity values")
...
ggplot(elements, aes(x = hardsoft_acidbase_theory,
                     y = specific_heat)) + 
  geom_boxplot() +
  labs(x = "Hard-Soft Acid-Base category", 
...
quiz(caption = "",
     ...
     question("What variable, if any, is on the Y axis?",
              ...
              answer("`metal_type`"),
              answer("`specific_heat`", correct = TRUE),
              answer("None of the above: A data transformation is on the Y-axis"),
              allow_retry = TRUE
              )
  )
```
...
ggplot(elements, aes(x = metal_type,
                     fill = hardsoft_acidbase_theory)) + 
  geom_bar() +
  labs(x = "Metal Type", 
       y = "Count") +
  scale_fill_brewer(palette = "Set2", name = "HSAB Category") +
  theme(axis.text.x = element_text(size=7), 
...
quiz(caption = "",
     ...
     question("But wait! Obviously there is also a representation of `hardsoft_acidbase_theory` in this plot, but it's not on the X or the Y axis. How is this information communicated in the plot?",
            answer("The bars are _colored_ by `hardsoft_acidbase_theory` category.", correct = TRUE),
...
ggplot(elements, aes(x = number_of_protons,
                     y = specific_heat)) + 
  geom_point() +
  labs(x = "Number of protons", 
       y = "Element specific heat")
...
ggplot(elements, aes(x = hardsoft_acidbase_theory,
                     y = number_of_protons)) + 
  geom_jitter(aes(color = hardsoft_acidbase_theory), width=0.2) +
  labs(x = "HSAB category", 
       y = "Number of protons") + 
...
quiz(caption = "",
     ...
     question("But wait! There are also different colors of points in the plot. Are all points the same color, or does color _vary_ among points based on something else?",
            answer("All points are the same color"),
            answer("Point colors vary based on the element's HSAB category.", correct = TRUE),
            answer("Point colors vary based on how many protons the element has."),
            answer("This is not the answer."),
            allow_retry = TRUE)
  )
```
...
ggplot(elements, aes(x = hardsoft_acidbase_theory,
                     y = number_of_protons)) + 
  geom_jitter(aes(color = number_of_protons), width=0.2) +
  labs(x = "HSAB category", 
       y = "Number of protons") + 
  theme(legend.position = "none")

quiz(
     question("Again, we see also different colors of points in the plot. Are all points the same color, or does color _vary_ among points based on something else?",
            answer("All points are the same color"),
            answer("Point colors vary based on the element's HSAB category."),
            answer("Point colors vary based on how many protons the element has.", correct = TRUE),
            answer("This is not the answer."),
            allow_retry = TRUE)
  )
```
...
#### Consider this _third_ version of the SAME figure**, and answer the subsequent question.
...
#### Consider this _FOURTH_ (and final) version of the SAME figure**, and answer the subsequent question.
...
quiz(
     question("This plot version clearly looks different from the previous versions. What has changed?",
            answer("There are more HSAB categories on the X-axis than before, but the rest remains the same."),
