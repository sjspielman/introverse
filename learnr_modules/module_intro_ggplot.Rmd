...
# Next, UNCOMMENT this code and run it to see some awesome.
# IMPORTANT: this does NOT change the definition of `sparrow_wing_femur_plot`
#sparrow_wing_femur_plot +
...
11. Make one more version of this figure that contains the following features:
...
Strip Plot   | [`geom_jitter()`](https://ggplot2.tidyverse.org/reference/geom_jitter.html)  | Or, `geom_point(position = "jitter")`!
