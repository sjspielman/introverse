...
TABLE OF COMMON VERBS GOES HERE.
<br>
...
## Set 1: Using `dplyr` verbs: REMOVE SELECT AND ADD MORE QUESTIONS
...
msleep %>%
  drop_na() # No column specified means ALL rows
```
...
iris %>%
 #       new column name              condition             if true    if false
  mutate(is_it_setosa = dplyr::if_else(Species == "setosa",   "Yes",      "No") )
```
