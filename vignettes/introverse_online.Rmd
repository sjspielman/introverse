...
+ [Tutorial on using any color/fill scale](https://spielmanlab.github.io/introverse/articles/color_fill_scales.html)
+ [Specifying _custom_ color/fill scale mappings](../introverse_docs/ggplot2_scale_color_manual.html)
+ [Specifying `colorbrewer` color/fill scale mappings](../introverse_docs/ggplot2_scale_color_brewer.html) 
+ [Specifying `viridis` color/fill scale mappings](../introverse_docs/ggplot2_scale_color_distiller.html) 
