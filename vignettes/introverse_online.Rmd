...
| [**`ggplot()`**](../introverse_docs/ggplot2_ggplot.html) | Tell ggplot which dataset to plot and establish a ggplot canvas |
...
| [**`theme_classic()`**](../introverse_docs/ggplot2_theme_classic.html) | Specify the "classic" theme |
| [**`theme_dark()`**](../introverse_docs/ggplot2_theme_dark.html) | Specify the built-in "dark" theme |
| [**`theme_gray()`**](../introverse_docs/ggplot2_theme_gray.html) | Specify the built-in "gray" (default) theme|
| [**`theme_grey()`**](../introverse_docs/ggplot2_theme_grey.html) | Specify the built-in "grey" (default) theme|
| [**`theme_light()`**](../introverse_docs/ggplot2_theme_light.html) | Specify the built-in "light" theme|
| [**`theme_linedraw()`**](../introverse_docs/ggplot2_theme_linedraw.html) | Specify the built-in "linedraw" theme|
| [**`theme_minimal()`**](../introverse_docs/ggplot2_theme_minimal.html) | Specify the built-in "minimal" theme|
| [**`theme_void()`**](../introverse_docs/ggplot2_theme_void.html) | Specify the built-in "void" theme|
